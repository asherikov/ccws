...
CCWS_SYSTEMD_UNIT_INSTALL_DIR="/lib/systemd/system"
CCWS_UDEV_RULE_INSTALL_DIR="/lib/udev/rules.d"
CCWS_EXTRA_INSTALL_DIRS="${CCWS_SYSTEMD_UNIT_INSTALL_DIR} ${CCWS_UDEV_RULE_INSTALL_DIR}"
export CCWS_SYSTEMD_UNIT_INSTALL_DIR CCWS_UDEV_RULE_INSTALL_DIR CCWS_EXTRA_INSTALL_DIRS
