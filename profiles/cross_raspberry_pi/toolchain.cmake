...
set(CMAKE_FIND_ROOT_PATH "$ENV{CCWS_COMPILER_ROOT};${CMAKE_INSTALL_PREFIX};${CMAKE_SYSROOT}/usr/;$ENV{CCWS_ROS_ROOT}" CACHE STRING "" FORCE)
...
include_directories(SYSTEM "/usr/include/c++/${CCWS_GCC_VERSION}/")
...
link_directories("/usr/lib/gcc/${CMAKE_LIBRARY_ARCHITECTURE}/${CCWS_GCC_VERSION}")
...
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} \
    ...
    -Wl,-rpath-link,$ENV{CCWS_ROS_ROOT}/lib" CACHE STRING "" FORCE)
