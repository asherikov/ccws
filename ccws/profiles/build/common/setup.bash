...
CCWS_LOG_DIR=${CCWS_LOG_DIR:-"${CCWS_BUILD_DIR}/.ccws/log/"}
#CCWS_SOURCE_DIR set in Makefile
...
CCWS_PROOT_BIN="${CCWS_TOOLS_DIR}/proot"
...
then
    ...
    CCWS_INSTALL_DIR_BUILD="${CCWS_INSTALL_DIR}"
