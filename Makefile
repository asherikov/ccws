...
export CCWS_BUILD_DIR=${WORKSPACE_DIR}/build/${CCWS_BUILD_PROFILES_ID}
export CCWS_INSTALL_DIR=${WORKSPACE_DIR}/install/${CCWS_BUILD_PROFILES_ID}
export CCWS_ARTIFACTS_DIR?=${WORKSPACE_DIR}/artifacts/${CCWS_BUILD_PROFILES_ID}
